...
export default function Header() {
    ...
    return (
        <div className={`fixed top-0 h-12 z-10 w-full items-center transition-all duration-500 ease-in ${show && 'bg-black'}`}  >
            < div className=" flex justify-between">
                ...
                <img className='fixed top-2 right-5 h-8 object-contain' src="./superhero.png" alt="" width={50}
                    height={50} />
